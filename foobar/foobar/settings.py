...
ASGI_APPLICATION = "foobar.asgi.application"
...
LOGGING = {
    ...
    "handlers": {
        "console": {
            ...
            "filters": [
                "correlation_id_filter"
            ],  # Add the correlation_id to all console logs
        },
    ...
    "loggers": {
        ...
        "django.db.backends": {
            ...
            "handlers": ["console_db"]
            if DEBUG
            else [],  # Use the dedicated console_db handler
...
SCHEDULER_QUEUES: dict[str, QueueConfiguration] = {
    "default": QueueConfiguration(URL=os.environ["REDIS_URL"])
}
